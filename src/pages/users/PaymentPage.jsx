                                ...
                                <Form className="selectPaymentOption">
                                  ...
                                  <div className="formRadioGroup bgGray mb-2">                        
                                    ...
                                    <div className="payInfoDetails clearfix">
                                        ...
                                        <Row className="align-items-center">
                                          <Col sm="10">
                                            <Form.Group>
                                              ...
                                              <Form.Control type="text" id="card-number" />
                                            </Form.Group>{/* end of Form.Group */}
                                          </Col>{/* end of Form.Group */}

                                          <Col>
                                            <img src="../assets/images/user/card_icon_img.png" alt="" />
                                          </Col>{/* end of Col */}
                                        </Row>{/* end of Row */}
                                        ...
                                        <Row className="align-items-center justify-content-between">
                                          <Col sm="3">
                                            <Form.Group>
                                              ...
                                              <ul class="cardPayFiled d-flex align-items-center justify-content-end">
                                                <li><Form.Control type="text" id="card-mm" placeholder="MM" /></li>
                                                <li class="cardBl">/</li>
                                                <li><Form.Control type="text" id="card-yy" placeholder="YY" /></li>
                                              </ul>{/* end of cardPayFiled */}
                                            </Form.Group>{/* end of Form.Group */}
                                          </Col>{/* end of Col */}
                                          ...
                                          <Col sm={{offset: 4}}>
                                            <Form.Group>
                                              ...
                                              <Form.Control type="text" id="card-cvv" />
                                            </Form.Group>{/* end of Form.Group */}
                                          </Col>{/* end of Col */}
                                      ...
                                      </div>{/* end of cardInfoForm */}
                                    </div>{/* end of payInfoDetails */}
