...
let cartItem = JSON.parse(localStorage.getItem('session'))


const cart = () => cartItem !==null ? cartItem.length : 0;
...
function HeaderComponent() {
  ...
  const [open, setOpen] = useState(false);
    ...
    <li><Link to="/cart"><span className="cartBadge"><i className="fas fa-shopping-cart"></i> <Badge variant="primary">{useEffect(()=>cart())}</Badge></span> Cart</Link></li>
