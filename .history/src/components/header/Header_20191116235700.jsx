...
function HeaderComponent() {
  ...
  const [open, setOpen] = useState(false);
    ...
    <li><Link to="/cart"><span className="cartBadge"><i className="fas fa-shopping-cart"></i> <Badge variant="primary">{!null? JSON.parse(localStorage.getItem('session')).length : 0}</Badge></span> Cart</Link></li>
